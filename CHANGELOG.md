...
- MCP tool names are qualified by server as `{server}_{tool}`. The `0.22.0` store upgrade rewrites existing chat selections for servers reachable at that launch. ([#321](https://github.com/ggozad/oterm/issues/321))
